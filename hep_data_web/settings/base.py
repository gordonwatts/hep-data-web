...
HEP_DATA_LLM_SERVICEX_AWKWARD_DOCKER_IMAGE = env("HEP_DATA_LLM_SERVICEX_AWKWARD_DOCKER_IMAGE")
HEP_DATA_LLM_RDF_DOCKER_IMAGE = env("HEP_DATA_LLM_RDF_DOCKER_IMAGE")
HEP_DATA_LLM_DOCKER_IMAGE_GLOBAL_FALLBACK = env("HEP_DATA_LLM_DOCKER_IMAGE_GLOBAL_FALLBACK")
HEP_DATA_LLM_DOCKER_IMAGE = env("HEP_DATA_LLM_DOCKER_IMAGE")
JOB_QUEUE_LIMIT = int(env("JOB_QUEUE_LIMIT", "20"))
JOB_POLL_INTERVAL_SECONDS = int(env("JOB_POLL_INTERVAL_SECONDS", "1"))
